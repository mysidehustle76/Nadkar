            ...
            <form onSubmit={addVendor} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  {/* Standard Yellow Pages Categories */}
                  ...
                  <option value="Barbers & Hair Salons">Barbers & Hair Salons</option>
                  <option value="Beauty & Wellness">Beauty & Wellness</option>
                  <option value="Bicycle Sales & Service">Bicycle Sales & Service</option>
                  <option value="Building Materials">Building Materials</option>
                  <option value="Catering">Catering</option>
                  <option value="Childcare & Preschools">Childcare & Preschools</option>
                  ...
                  <option value="Dance & Music Lessons">Dance & Music Lessons</option>
